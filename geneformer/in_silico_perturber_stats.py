...
if ORGANISM == "human" :
    if MH_FLAG == True :
        ...
        GENE_NAME_ID_DICTIONARY_FILE = "/mnt/keita/data/scRNA-datas/human_data/Geneformer/genecorpus-30M/token_dictionary_v3_GeneSymbol_to_EnsemblID.pkl"
elif ORGANISM == "mouse" :
    if MH_FLAG == True :
        ...
        GENE_NAME_ID_DICTIONARY_FILE = "/mnt/keita/data/scRNA-datas/mouse_data/mouse-Geneformer/mouse-genecorpus-20M/data1-v2/tokens/MLM-re_token_dictionary_v3_GeneSymbol_to_EnsemblID.pkl"
else :
